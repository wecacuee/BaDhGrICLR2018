...
\author{Shurjo Banerjee$^1$\footnotemark[1],%
  \, Vikas Dhiman$^1$\thanks{The first two authors contributed equally.},%
  \, Brent Griffin$^1$,%
  \, Jeffrey M. Siskind$^2$,%
  \, Jason J. Corso$^1$\\
...
West Lafayette, IN\\
\texttt{$^1$\{shurjo,dhiman,griffb,jjcorso\}@umich.edu,$^2$qobi@purdue.edu} \\
}
