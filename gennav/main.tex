...
\begin{abstract}
  ...
  Yet, from experiments and analysis in this earlier work, it is not clear by what strategies these algorithms are navigating the mazes and finding the goal.
  ...
  We extend the experiments in \cite{MiPaViICLR2017} by separating the set of training and testing maps and by a more ablative coverage of the space of experiment.
  ...
  However, when tested on unseen maps the algorithms utilize a wall-following strategy to find the goal without doing any mapping or path planning.
\end{abstract}
