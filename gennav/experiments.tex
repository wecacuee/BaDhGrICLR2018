...
The agent is tasked to find the goal as many times as possible over within a fixed amount of time, respawning at the spawn location each time it reaches the goal.
...
The wall penalty is useful to prevent agents from moving along the walls, thereby discarding vision intput for exploration.
% Reward formulation
