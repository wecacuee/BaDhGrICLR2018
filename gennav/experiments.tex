...
The metric \emph{distance traveled : shortest path} is defined as the ratio of total distance traveled by the agent versus the sum of approximate shortest distances to the goal for every goal hit, except for the first iteration of finding the goal.
