...
The metric \emph{distance traveled : shortest path} is defined as the ratio of total distance traveled by the agent verses the sum of approximate shortest distances to the goal.
