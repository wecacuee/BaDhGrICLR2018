...
from sqldsl import (select, where_all
                    , where_str_contains, where_equals
                    , where_not, where_not_nan
                    , default_keys_transform, group_by)
...
_default_nan = lambda r : float('nan')
conf.default_key_values = [
    (u"loaded_model", lambda r: r[u"chosen_map"])
    , (u"dist_ratio_per_episode", _default_nan)
    , (u"dist_ratio_per_episode_std", _default_nan)
    , (u"prob_shortest_per_episode", _default_nan)
    , (u"prob_shortest_per_episode_std", _default_nan)
