Our experimental setup is \cite{MiPaViICLR2017} work. We summarize the technical setup here for completeness. We recommend \cite{MnBaMiICML2016,MiPaViICLR2017} for more details of the setup.
