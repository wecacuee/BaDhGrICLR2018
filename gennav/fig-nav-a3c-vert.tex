...
\node[networknode,fill=orange!20,below=0.4 of lstm]  (enc2) {\parbox{10ex}{CNN:32\\4x4/2x2}};
\node[networknode,,fill=orange!20,below=0.4 of enc2]  (enc) {\parbox{10ex}{CNN:16\\8x8/4x4}};
\node[below=0.4 of enc, inputvar] (It) {$I_t$:84x84x3};
\node[left=0.1 of It,inputvar] (at) {$\acttp$};
\node[right=0.1 of It,inputvar]  (rt) {$\rewtp$};
\node [above=0.8 of lstm2,outvar] (V)  {$V$, $\pi$};
\node [shift={(-0,0)},left=0.4 of V,auxvar] (pi)  {$L$};
\node [shift={(-0,0)},right=0.4 of V,auxvar] (D)  {$D_2$};
