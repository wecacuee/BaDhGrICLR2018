...
\begin{description}
  \ditem{Evaluate on training map with fixed goal location}
  ...
  \ditem{Evaluate on training maps with random goal location}
  ...
  \ditem{Evaluate on unseen maps}
    ...
    \begin{description}
      \dditem{Remember and repeat (Wrench map)}
      ...
      %\dditem{Frame to action mapping}

      %\dditem{Full path planning}
