...
\node[networknode,fill=orange!20,left=0.8 of lstm]  (enc2) {\parbox{0.4in}{CNN:32\\4x4/2x2}};
\node[networknode,,fill=orange!20,left=0.4 of enc2]  (enc) {\parbox{0.4in}{CNN:16\\8x8/4x4}};
